...
<body>
    <div class="sidebar close">
        <div class="logo-details" >
            ...
            <span class="logo_name" >JC Medicals</span>
        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{route('detalleingresos.index')}}">Ingresos</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="{{route('clientes.index')}}">Clientes</a></li>
                </ul>
            </li>
            <li>
                <a href="#">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{route('detalleingresos.index')}}">Reporte Ingresos</a></li>
                    <li><a href="{{route('detalleventas.index')}}">Reporte Ventas</a></li>
                </ul>
            </li>
            <li>
                <a href="#">
